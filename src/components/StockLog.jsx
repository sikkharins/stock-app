...
export default function LogPage({sh}){
  const{pN,cN,products,logs,setLogs,search,setSearch,sales,contacts,payments,pos,cnotes,billings,defectives,canE,canD}=sh;
  ...
  const ed=canE("stock_log");const cd=canD("stock_log");
