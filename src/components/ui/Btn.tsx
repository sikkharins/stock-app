...
export default function Btn({ onClick, children, variant, size }: BtnProps) {
  const base: CSSProperties = {fontSize:13,padding:"6px 13px",borderRadius:7,cursor:"pointer",fontFamily:"inherit",fontWeight:500,display:"inline-flex",alignItems:"center",gap:6,whiteSpace:"nowrap",border:"1px solid var(--line)",background:"var(--bg2)",color:"var(--text)"};
