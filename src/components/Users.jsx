...
const ROLE_PRESETS={
  ...
  Accountant:t=>["finance","financial_calendar"].includes(t)?{access:true,read:true,create:true,edit:true,delete:false,approve:false}:["dashboard","stock_log","reports"].includes(t)?{access:true,read:true,create:false,edit:false,delete:false,approve:false}:{access:false,read:false,create:false,edit:false,delete:false,approve:false},
  SalesManager:t=>["dashboard","products","reports","ai_bot","sales_overview","financial_calendar"].includes(t)?{access:true,read:true,create:false,edit:false,delete:false,approve:false}:["sales","customers","purchase"].includes(t)?{access:true,read:true,create:true,edit:true,delete:false,approve:true}:{access:false,read:false,create:false,edit:false,delete:false,approve:false},
  Sales:t=>["dashboard","products","ai_bot","sales_overview"].includes(t)?{access:true,read:true,create:false,edit:false,delete:false,approve:false}:["sales","customers"].includes(t)?{access:true,read:true,create:true,edit:false,delete:false,approve:false}:{access:false,read:false,create:false,edit:false,delete:false,approve:false},
