...
function SOList({sh}){
  ...
  return <div>
    ...
    {viewProfile&&<CustomerProfile customer={viewProfile} sales={sales} quotes={quotes} payments={payments} products={products} pN={pN} promos={promos||[]} setContacts={setContacts} canEdit={canC("sales")} onClose={()=>setViewProfile(null)}/>}
  </div>;
}
