...
export default function FinPage({sh}){
  const{cN,pN,contacts,setContacts,pos,sales,quotes,payments,setPayments,products,setProducts,canE,canD,modal,oM,cM,setCheques,bankAccs,setBankAccs,bankTxns,setBankTxns,cnotes,setCNotes,addLog,defectives,setDefectives,cu,billings,supCNotes,setSupCNotes,cashCats,setCashCats,tagMappings,setTagMappings}=sh;
