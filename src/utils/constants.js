export const ALL_TABS = ["dashboard","products","stock_log","purchase","sales","promos","events","finance","reports","sales_overview","financial_calendar","suppliers","customers","defective","delivery_planning","ai_bot"];
export const TAB_LABELS = {dashboard:{en:"Dashboard",th:"แดชบอร์ด"},products:{en:"Products",th:"สินค้า"},stock_log:{en:"Stock Log",th:"ประวัติสต็อก"},purchase:{en:"Purchase Orders",th:"ใบสั่งซื้อ"},sales:{en:"Sales",th:"การขาย"},finance:{en:"Finance",th:"การเงิน"},reports:{en:"Reports",th:"รายงาน"},suppliers:{en:"Suppliers",th:"ซัพพลายเออร์"},customers:{en:"Customers",th:"ลูกค้า"},users:{en:"Users",th:"จัดการ User"},defective:{en:"Defective",th:"สินค้าชำรุด"},promos:{en:"Promotions",th:"โปรโมชั่น"},events:{en:"Events",th:"งานอีเวนต์"},sales_overview:{en:"Sales Overview",th:"ภาพรวมเซลส์"},financial_calendar:{en:"Cash Flow",th:"ปฏิทินการเงิน"},delivery_planning:{en:"Delivery Planning",th:"วางแผนจัดส่ง"},ai_bot:{en:"AI Bot",th:"AI Bot"}};
