...
├───────────────────────────────────────────────────────────────┤
│  💵  เงินสดหน้าร้าน        ฿12,500      [⇆ โอน] [+ รายการ] [⋯] │
│  💵  Petty cash             ฿800        [⇆ โอน] [+ รายการ] [⋯] │
│  🏦  กสิกร — บัญชี 1        ฿245,890    [⇆ โอน] [+ รายการ] [⋯] │
│  🏦  SCB  — บัญชี 2         ฿58,200     [⇆ โอน] [+ รายการ] [⋯] │
│  🏦  TTB  — บัญชี 3         ฿0          [⇆ โอน] [+ รายการ] [⋯] │
└───────────────────────────────────────────────────────────────┘
[ประวัติรายการ filtered by selected account]
```

Cash accounts: green badge `💵`, no bank icon, no `accNo` column.
